...
namespace XIIRPL2_15_Ticketing.MasterForm
{
    public partial class FrmMasterKodePromo : Form
    {
        ...
        private void txtBerlakuSampai_ValueChanged(object sender, EventArgs e)
        {

        }

        private void txtPersentaseDiskon_ValueChanged(object sender, EventArgs e)
        {

        }

        private void txtMaksimumDiskon_ValueChanged(object sender, EventArgs e)
        {
